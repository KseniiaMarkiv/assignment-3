...
Both the tablet view and the desktop view of what's graded and required is the same. Here is the mockup illustration of the desktop & tablet version of the site (only required graded parts shown):
 ...
 ![Desktop and Tablet](mod3_solution/images/desktop.png)


Here is the mockup illustration of the mobile view (only required graded parts are shown):

 ![mobile collapsed](mod3_solution/images/menu-collapsed.png)

 ![mobile expanded](mod3_solution/images/mobile-expanded.png)
...
Here is the mockup illustration of the desktop version of the site: ![Desktop - optional](mod3_solution/images/desktop-optional.png)

Here is the mockup illustration of the tablet version of the site:   

![Tablet - optional](mod3_solution/images/tablet-optional.png)
...
![Mobile - Optional (Closed)](mod3_solution/images/mobile-optional-collapsed.png)
![Mobile - Optional (Open)](mod3_solution/images/mobile-optional-expanded.png)
